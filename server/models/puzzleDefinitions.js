module.exports = {
    ...
    '3': {
      ...
      queries: [
        { text: "SELECT bm.*, p.name FROM backstage_movements bm LEFT JOIN personnel p ON bm.person_id = p.person_id WHERE bm.person_id = 'P1100';" },
        { text: "SELECT * FROM backstage_movements WHERE room_id = 'R-01';" },
